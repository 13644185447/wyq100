					...
					<div class="plugin-package-list">
						...
						<div class="plugin-package-list-plugin row">
							...
							<span class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
								<i>
									<img  onerror="this.src='<?php echo EWEI_SHOPV2_LOCAL;?>static/images/plugin.png'" src="<?php echo empty($r['thumb'])?'../addons/ewei_shopv2/static/images/plugin.png': tomedia($r['thumb'])?>" alt="<?php  echo $r['name'];?>">
								</i>
							</span>
							<?php  } } ?>
						</div>
			...
			<ul class="plugingrant-plugin-list-ul row">
				...
				<li class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
					<a href="<?php  echo webUrl('plugingrant/detail',array('id'=>$row['id'],'type'=>'plugin'))?>" class="plugingrant-plugin-list">
						<img src="<?php echo empty($row['thumb'])?'../addons/ewei_shopv2/static/images/plugin.png': tomedia($row['thumb'])?>" alt="<?php  echo $row['name'];?>">
