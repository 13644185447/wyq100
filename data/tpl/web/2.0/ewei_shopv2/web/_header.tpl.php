    ...
    <ul class="nav navbar-top-links navbar-right">
        <li class="dropdown">
            ...
            <ul role="menu" class="dropdown-menu">
                ...
                <li><a href="<?php echo IMS_VERSION>1 ? "./index.php?c=account&a=post&uniacid=".$GLOBALS['_W']['uniacid']."&acid=".$GLOBALS['_W']['acid'] : "./index.php?c=account&a=post&uniacid=".$GLOBALS['_W']['uniacid'];?>" target="_blank"><i class="icon icon-wechat"></i>  编辑公众号</a></li>
